...
const weatherCall = (dates, currentState, latitude, longitude) => {
    return (dispatch) => {
        ...
        for (let i = 11; i <= 13; i++) {
            ...
            const cors = 'https://cors-anywhere.herokuapp.com/';
            const url = `https://api.darksky.net/forecast/8b01861d3b06ab86ba285ef08d52c88d/${latitude},${longitude},${queryDate}T00:00:00?exclude=currently,hourly,flags&units=si`;
